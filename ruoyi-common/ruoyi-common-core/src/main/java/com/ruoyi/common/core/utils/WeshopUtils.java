...
public class WeshopUtils {
    ...
    public static String generatePromptByType(String type, String basePrompt) {
        String prompt1 = "使用上面这张图片，根据文字描述，生成1张高分辨率图片，不要改变背景，如果背景中有不明线条需要去掉，不要袜套,不要包,不要帽子,如果有手套需要和衣服颜色匹配，鞋子为纯色高帮户外鞋，鞋子正常踩在地上,不要悬空，鞋子要完整，不要脚印，衣服有领儿的，不要改变领儿，衣服袖口不要改变，不要改变上衣尺寸，搭配个小裙子，针织紧身裤，材质看起来厚实且有纹理，紧密贴合腿部，既保暖又能勾勒出腿部线条，搭配的是一双'UGG'品牌冬季靴，靴口处有大面积的白色毛绒装饰，既增加了温暖感，又提升了整体造型的可爱与时尚度。厚底设计还能在雪地行走时提供一定的防滑和增高效果。白色针织紧身裤恰好被塞进雪地靴的毛绒靴口内，这种搭配方式不仅让整体造型显得利落整洁，还能更好地发挥裤子和鞋子的保暖功能，同时在视觉上形成和谐的衔接，凸显出穿搭的层次感与时尚感，非常适合雪地的寒冷环境。人物面带笑容，人物的手更像欧洲人的手，人物姿势更有型。将图片中人物的体型缩小，使其在画面中的占比更小，视觉上符合身高不超过180cm 的比例，同时保持人物与背景的相对位置和整体画面的协调性，就像把人物按比例缩小，让其看起来更小巧精致，与周围环境更适配。人体、衣服、环境更加和谐，尤其是人体、衣服、环境中的光线和阴影要契合。专业摄影，整体拍摄风格呈现高清细节质感，类似时尚杂志封面设计。";
