...
public class WeshopUtils {
    ...
    public static String generatePromptByType(String type, String basePrompt) {
        String prompt1 = "使用上面这张图片，根据文字描述，生成1张高分辨率图片，不要改变背景，如果背景中有不明线条需要去掉，不要帽子，不要包，如果有手套需要和衣服颜色匹配；姿势不要插兜。蓬松长款羽绒服内搭白色上衣，搭配黑色修身喇叭裤，黑色皮鞋，戴黑色带BOSIDENG字母针的织帽，脖子上挂一个深灰色耳麦。人物比较冷酷，人物的手更像亚洲人的手，人物姿势更有型。将图片中人物的体型缩小，使其在画面中的占比更小，视觉上符合身高175-180cm，腿较长的专业模特比例，同时保持人物与背景的相对位置和整体画面的协调性，就像把人物按比例缩小，让其看起来更小巧精致，与周围环境更适配。人体、衣服、环境更加和谐，尤其是人体、衣服、环境中的光线和阴影要契合。专业摄影，整体拍摄风格呈现高清细节质感，类似时尚杂志封面设计。";
