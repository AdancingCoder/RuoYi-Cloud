  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="模特类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择模特类型" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="modelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="模特名称" align="center" prop="name" />
      ...
      <el-table-column label="模特类型" align="center" prop="type">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="模特名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入模特名称" />
        </el-form-item>
        ...
        <el-form-item label="模特类型" prop="type">
          <el-select v-model="form.type" placeholder="请选择模特类型">
            <el-option
              v-for="dict in dict.type.brand_type"
              :key="dict.value"
              :label="dict.label"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除模特编号为"' + ids + '"的数据项？').then(function() {
        return delModel(ids)
      }).then(() => {
        this.getList()
